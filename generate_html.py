...
def load_data():
    ...
    # 尝试 latest.json
    if os.path.exists(os.path.join(ROOT_DIR, "latest.json")):
        with open(os.path.join(ROOT_DIR, "latest.json"), 'r', encoding='utf-8') as f:
            return json.load(f)
...
def generate_html(data):
    ...
    llm_ratio = tech_dist.get("语言模型", 0) / sum(tech_dist.values()) * 100 if tech_dist else 0
...
<body>
    <div class="container">
        ...
        <div class="card">
            <h2>🎨 技术词云</h2>
            <img src="wordcloud_{date}.png" alt="技术词云" style="width: 100%; border-radius: 8px;">
        </div>
        
        <div class="image-grid">
            <div class="image-card">
                <h3>热门模型排行榜</h3>
                <img src="leaderboard_{date}.png" alt="排行榜">
            </div>
            <div class="image-card">
                <h3>技术领域分布</h3>
                <img src="tech_distribution_{date}.png" alt="技术分布">
            </div>
        </div>
        ...
        <div class="image-grid">
            <div class="image-card">
                <h3>模型热度分布（气泡图）</h3>
                <img src="bubble_chart_{date}.png" alt="气泡图">
            </div>
            <div class="image-card">
                <h3>活跃组织排行</h3>
                <img src="org_ranking_{date}.png" alt="组织排行">
            </div>
        </div>
